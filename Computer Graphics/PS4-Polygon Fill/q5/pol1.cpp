...
void display()
{
    ...
    int a[]={30,90,30,20,60,20,100,80,90,140,60,80,40,120};
    dcPt *polygon1 = makePoints(a,7);
    drawPolygon(polygon1,7);
    scanFill(polygon1,7);


    int b[]={130,50,190,50,190,90,130,90,120,60,110,100,130,120,200,120,220,70,200,30,130,30};
    dcPt *polygon2 = makePoints(b,11);
